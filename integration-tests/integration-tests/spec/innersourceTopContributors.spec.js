...
describe('Testing top innersource contributors endpoint', () => {
  ...
  it('[Innersource] Should verify complete list of contributors with default values', async (done) => {
    ...
    const topContributor4 = responseInnersource.body.data[3].contributionWeight;

    let flag = false;
    if ((topContributor1 > topContributor2) && (topContributor1 > topContributor3)
      && (topContributor1 > topContributor4)) {
      flag = true;
    }
