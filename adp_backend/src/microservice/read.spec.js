// ============================================================================================= //
/**
* Unit test for [ global.adp.microservice.read ]
...
describe('Testing if [ global.adp.microservice.read ] is able to read a MicroService (SIMULATION)', () => {
  beforeEach(() => {
    global.adp = {};
    adp.models = {};
    ...
    global.adp.microservice.read = proxyquire('./read', {
  ...
  it('Testing with a valid mock ID.', async (done) => {
    ...
    await global.adp.microservice.read(validMockJSON)
      .then((expectedOBJ) => {
  ...
  it('Testing with a invalid mock ID, Microservice cannot be found.', async (done) => {
    const inValidMockJSON = 'MOCKINVALIDID';
    await global.adp.microservice.read(inValidMockJSON)
      .then((expectedOBJ) => {
