// ============================================================================================= //
/**
* Unit test for [ global.adp.migration.dataNormalize ]
* @author Armando Dias [zdiaarm]
*/
/* eslint-disable no-underscore-dangle */
/* eslint-disable global-require */
// ============================================================================================= //
describe('Testing [ global.adp.migration.dataNormalize ] Behavior.', () => {
  // ------------------------------------------------------------------------------------------- //
  beforeEach(() => {
    // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - //
    global.adp = {};
    ...
    global.adp.migration.dataNormalize = require('./dataNormalize');
    // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - //
  });
  // ------------------------------------------------------------------------------------------- //
  afterEach(() => {
  ...
  // ------------------------------------------------------------------------------------------- //
  it('Normalizing a mock Asset', (done) => {
    const mockAsset = {
      reusability_level: 'Open for Reuse',
      service_category: 'ADP Application Specific Services',
    };
    const result = global.adp.migration.dataNormalize(mockAsset);

    expect(result.reusability_level).toBe(2);
    expect(result.service_category).toBe(4);
    done();
  });
  // ------------------------------------------------------------------------------------------- //
  it('Normalizing a mock Asset ( Other values )', (done) => {
    const mockAsset = {
  ...
  // ------------------------------------------------------------------------------------------- //
  it('Should return "false" if [global.adp.listOptions.cache.options] is not available', (done) => {
