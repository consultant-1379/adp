// ============================================================================================= //
/**
* [ global.adp.assembly.read ]
* Retrieve an Assembly for reading.
* @param {String} ID A simple String with the ID of the Assembly.
* @return {JSON} Returns a JSON Object containing the information of the Assembly.
...
module.exports = (ID, USEROBJECT) => new Promise((RESOLVE, REJECT) => {
  const dbModel = new adp.models.Adp(['assembly']);
  const timer = new Date();
  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - //
  const packName = 'global.adp.assembly.read';
