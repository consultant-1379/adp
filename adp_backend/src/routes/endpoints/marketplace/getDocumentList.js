// ============================================================================================= //
/**
* [ global.adp.endpoints.marketplace.getDocumentList ]
...
/**
 * @swagger
 * /marketplace/microservice/{MicroserviceSlug/ID}/{DocumentVersion}:
 *    get:
...
module.exports = async (REQ, RES) => {
  ...
  const packName = 'global.adp.endpoints.marketplace.getDocumentList';
